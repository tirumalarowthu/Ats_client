                    ...
                    <CCard className="mb-4 container">
                        ...
                        <CCardBody>
                            <CRow>
                                <CForm className="row g-3 needs-validation">
                                    ...
                                    <CCol md={6}>
                                        <CFormInput type="text" className='form-control' name="area" value={appData.area} readOnly label="Area for Online Assessment Test" />
                                    </CCol>
                                    <CCol md={6}>
                        ...
                        <div className="container mb-2">
                            <div className='d-flex justify-content-between container'>
                                <Link to="/ChangeApplicantStatus" onClick={() => dispatch(GetApplicant(appData))}> <button className='btn btn-primary '>Change Applicant Status</button></Link>
...
/////Original code for update applicant
